...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={clsx(
      ...
      'group-[.destructive]:border-gray-100/40 group-[.destructive]:hover:border-red-500/30',
      'group-[.destructive]:hover:bg-red-500 group-[.destructive]:hover:text-gray-100',
      'group-[.destructive]:focus:ring-red-500 group-[.destructive]:focus:ring-offset-red-600',
      className
    )}
    {...props}
  />
